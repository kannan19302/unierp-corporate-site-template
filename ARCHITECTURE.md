# Architecture Specification: UniERP Tenant Corporate Site Template (`tenant-site-template`)
...
```mermaid
graph LR
  Callers["Allowed Inbound Callers<br/>Tenant website builders"] --> Repo["<b>tenant-site-template (L4)</b><br/>UniERP Tenant Corporate Site Template"]
...
### Boundary Contract
- **Allowed Inbound Consumers**: Tenant website builders
...
- **Primary Interface**: `@kannan19302/corporate-site-template`
...
- **Project Skill**: [`.agents/skills/tenant-site-template-standards/SKILL.md`](.agents/skills/tenant-site-template-standards/SKILL.md)
